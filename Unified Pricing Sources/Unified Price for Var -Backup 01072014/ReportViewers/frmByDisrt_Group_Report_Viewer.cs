...
{
    public partial class frmByDisrt_Group_Report_Viewer : Form
    {
        public frmByDisrt_Group_Report_Viewer()
        {
            InitializeComponent();
        }
        ...
        {
            CrystalReports.ByDistr_Group_Report rpt = new CrystalReports.ByDistr_Group_Report();
