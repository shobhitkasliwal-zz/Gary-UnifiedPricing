...
{
    public partial class frmItemsByCustFamily_Viewer : Form
    {
        public frmItemsByCustFamily_Viewer()
        {
            InitializeComponent();
        }
        ...
        {
            CrystalReports.ItemsByCustFamily rpt = new CrystalReports.ItemsByCustFamily();
