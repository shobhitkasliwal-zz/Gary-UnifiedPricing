...
{
    public partial class frmByCustomer_Comparison_Report_Viewer : Form
    {
        public frmByCustomer_Comparison_Report_Viewer()
        {
            InitializeComponent();
        }
        ...
        {
            CrystalReports.ByCustomer_Comparison_report rpt = new CrystalReports.ByCustomer_Comparison_report();
