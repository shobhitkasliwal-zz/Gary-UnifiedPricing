...
namespace UnifiedPricingDataImportApp
{
    ...
    {
        public static string _connectionString = Program.GlobalVariables["connectionString"].ToString();
            //"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + Path.Combine(Application.StartupPath, "UnifiedPricingDB.accdb") + ";Persist Security Info=False;";
