...
{
    public partial class frmReportViewerJustNew : Form
    {
        public frmReportViewerJustNew()
        {
            InitializeComponent();
        }
        ...
        {
            CrystalReports.ChangePriceReportJustNew rpt = new CrystalReports.ChangePriceReportJustNew();
