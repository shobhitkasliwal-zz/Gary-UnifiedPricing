...
{
    public partial class frmReport_Customer_BySalesPerson : Form
    {
        public frmReport_Customer_BySalesPerson()
        {
            InitializeComponent();
        }
        ...
        {
            CrystalReports.Report_Customer_BySalesPerson rpt = new CrystalReports.Report_Customer_BySalesPerson();
