...
{
    public partial class frmByItem_Comparison_Report_Viewer : Form
    {
        public frmByItem_Comparison_Report_Viewer()
        {
            InitializeComponent();
        }
        ...
        {
            CrystalReports.ByItem_Comparison_Report rpt = new CrystalReports.ByItem_Comparison_Report();
